...
PGPASSWORD=$DBPASS psql $DBNAME -U $DBUSER -c "DROP SCHEMA IF EXISTS $DBSCHEMA"
PGPASSWORD=$DBPASS psql $DBNAME -U $DBUSER -c "CREATE SCHEMA $DBSCHEMA AUTHORIZATION $DBUSER"
